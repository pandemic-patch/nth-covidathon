        ...
        <Form>
          ...
          <Form.Field>
            <Checkbox
              ...
              checked={this.state.selectedReasons.find(el => el.name === '3')}
              onChange={this.handleChange}
            />
          </Form.Field>
          <Form.Field>
            <Checkbox
              ...
              checked={this.state.selectedReasons.find(el => el.name === '4')}
              onChange={this.handleChange}
            />
          </Form.Field>
          <Form.Field>
            <Checkbox
              ...
              checked={this.state.selectedReasons.find(el => el.name === '5')}
              onChange={this.handleChange}
            />
          </Form.Field>
          <Form.Field>
            <Checkbox
              ...
              checked={this.state.selectedReasons.find(el => el.name === '6')}
              onChange={this.handleChange}
            />
          </Form.Field>
          <Form.Field>
            <Checkbox
              ...
              checked={this.state.selectedReasons.find(el => el.name === '7')}
              onChange={this.handleChange}
            />
          </Form.Field>
          <Form.Field>
            <Checkbox
              ...
              checked={this.state.selectedReasons.find(el => el.name === '8')}
              onChange={this.handleChange}
            />
          </Form.Field>
          <Form.Field>
            <Checkbox
              ...
              checked={this.state.selectedReasons.find(el => el.name === '9')}
              onChange={this.handleChange}
            />
          </Form.Field>
          <Form.Field>
            <Checkbox
              ...
              checked={this.state.selectedReasons.find(el => el.name === '10')}
              onChange={this.handleChange}
            />
          </Form.Field>
          <Form.Field>
            <Label>
              Tell us something totally random about yourself. We want weird.
              <br />
              <sub>
                I'll go first: I love putting vinegar and spicy mayonnaise on my
                white rice. For breakfast.
              </sub>
            </Label>
